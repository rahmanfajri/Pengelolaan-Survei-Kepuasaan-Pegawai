					...
					<div class="card-box">
						<div class="container">
							<div class="col-md-6">
								...
								?>
											<h4 class="m-t-0 m-b-30 header-title"><b>Hapus Satuan Kerja</b></h4>
											
											<h5><b>Pilih Satuan Kerja</b></h5>

											<form method="post" action="koneksi_delete.php">
											...
											<div class="form-group">
												<div align="center">
													<button type="submit" class="btn btn-default btn-rounded waves-effect waves-light" name="set">Hapus Satker</button>
												</div>
												</div>
											</form>
										</div>
