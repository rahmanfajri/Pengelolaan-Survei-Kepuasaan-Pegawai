						...
						<div class="row">
							<div class="col-sm-12">
								<div class="card-box">
									<div class="row">
										<div class="col-lg-10">
											<h4 class="m-t-0 header-title"><b>Set Tanggal</b></h4>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-lg-8">
			                                ...
			                                <div class="p-20">
			                                	<form action="koneksitgl.php" class="form-horizontal" method="POST">
												<div class="form-group">
												<label class="control-label col-sm-4">Pilih Satuan Kerja</label>
												<div class="col-sm-5">
												<select name="satker" class="form-control">
													<option>---</option>
													<option><?php echo "<h2>".$_SESSION['satker'], "</h2>";?></option>
												</select>
												</div>
												</div>
			                                		<div class="form-group">
