			...
			<h4 class="m-t-0 m-b-30 header-title"><b>History</b></h4>
						<div class="col-md-6">
							...
							<h4 class="m-t-0 m-b-30 header-title"><b>History Triwulan</b></h4>						
								<h5><b>Pilih Triwulan</b></h5>
									<form method="post" action="history_triwulan.php">
								...
								<h5><b>Pilih Tahun</b></h5>
									...
									<div align="center">
										<button type="submit" class="btn btn-success waves-effect waves-light" name="history">Pilih</button>
									</div>
                        <!-- Page-Title -->
						<br>
						</div>
